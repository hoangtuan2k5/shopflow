...
Giá và amount là số nguyên theo đơn vị VND; request có phần lẻ phải bị từ chối.
...
| `totalAmount` | number | `orders.total_amount` | NUMERIC(12,2); số nguyên VND; = sum line totals |
