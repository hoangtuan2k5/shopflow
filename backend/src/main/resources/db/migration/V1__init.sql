-- =====================================================================
-- Flyway migration V1 — Initialize ShopFlow MVP schema
-- DBMS  : PostgreSQL 14+
...
-- ---------------------------------------------------------------------
-- 2. CUSTOMERS  (optional in MVP - orders carry snapshot fields)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 3. INVENTORY_ITEMS  (1-1 with products)
-- ---------------------------------------------------------------------
...
-- available_stock is NOT stored — compute at runtime: on_hand_stock - reserved_stock


-- ---------------------------------------------------------------------
-- 4. ORDERS  (customer snapshot + shipping address inline)
-- ---------------------------------------------------------------------
CREATE TABLE orders (
    id                BIGSERIAL    PRIMARY KEY,
    customer_id       BIGINT,
...
-- ---------------------------------------------------------------------
-- 6. PAYMENTS  (1-N with orders to support retry)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 7. STOCK_MOVEMENTS  (central audit trail for stock changes)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 8. RECEIVING_RECORDS  (supplier stock-in)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 10. RETURN_REQUEST_ITEMS  (partial return per order_item)
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 11. DELIVERY_STATUS_HISTORY  (audit trail for FR-04.4)
-- ---------------------------------------------------------------------
